...
class SunUI extends StatefulWidget {
  const SunUI({super.key});

  @override
  _SunUIState createState() => _SunUIState();
}

class _SunUIState extends State<SunUI> {
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: Lottie.asset(
            'assets/weather/weather_sun.json',
        ...
        Center(
          child: Column(
            ...
            children: [
              Lottie.asset('assets/weather/character/character_sun.json', width: 200, height: 200),
              SizedBox(height: 20),
              Container(
