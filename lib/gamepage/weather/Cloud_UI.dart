...
class CloudUI extends StatefulWidget {
  ...
  const CloudUI({super.key, required this.windStrengthDescription});

  @override
  CloudUIState createState() => CloudUIState();
}

class CloudUIState extends State<CloudUI> {
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: Lottie.asset(
            'assets/weather/weather_cloud.json',
        ...
        Center(
          child: Column(
            ...
            children: [
              Lottie.asset('assets/weather/character/character_cloud.json', width: 200, height: 200),
              SizedBox(height: 20),
              Container(
